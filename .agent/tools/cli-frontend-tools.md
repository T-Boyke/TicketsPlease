...
- Migration: `dotnet ef migrations add [Name] --project src/TicketsPlease.Infrastructure \
  --startup-project src/TicketsPlease.Web --context AppDbContext`.
- Update: `dotnet ef database update --project src/TicketsPlease.Infrastructure \
