...
- Properties: Private setters `{ get; private set; }`. Use `static Create(...)`.
...
- Enforce bundling: Command/Query, Validator, and Handler for a specific Use Case MUST reside
  in ONE single file to maximize token efficiency.
