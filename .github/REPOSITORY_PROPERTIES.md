...
> [!IMPORTANT] This file serves as the **Source of Truth** for the Custom Properties that must be
> configured in the GitHub Repository Settings at the Organization level.

## Overview

Custom properties allow us to categorize and govern the `TicketsPlease` repository using structured
metadata. This data is used by GitHub for search, filtering, and automated ruleset enforcement.
