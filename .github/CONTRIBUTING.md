...
First off, thank you for considering contributing to **TicketsPlease**! It's people like you that
make it an enterprise-grade tool.

## 🏗️ Technical Standards

We follow strict architectural and coding standards. Please review our documentation before
starting:
...
This project is optimized for AI-assisted development. If you use AI tools (like Antigravity),
please use the `🤖 AI-Generated` flag in your Pull Request.
