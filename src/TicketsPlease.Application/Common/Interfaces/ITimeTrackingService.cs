...
public interface ITimeTrackingService
{
    ...
    Task StartTimeTrackingAsync(Guid ticketId, Guid userId);
    ...
    /// <param name="userId">Die ID des Benutzers.</param>
    /// <returns>Ein Task.</returns>
    Task StopTimeTrackingAsync(Guid ticketId, Guid userId);
    ...
    Task<IEnumerable<TimeLogDto>> GetTimeLogsAsync(Guid ticketId);
    ...
    Task<bool> IsTimerRunningAsync(Guid ticketId, Guid userId);
}
