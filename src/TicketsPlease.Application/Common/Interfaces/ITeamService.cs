...
public interface ITeamService
{
    ...
    Task<IEnumerable<TeamDto>> GetUserTeamsAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<TeamDto?> GetTeamDetailsAsync(Guid teamId, CancellationToken cancellationToken = default);
    ...
    Task<Guid> CreateTeamAsync(string name, string description, string colorCode, Guid creatorUserId, CancellationToken cancellationToken = default);
    ...
    Task AddMemberAsync(Guid teamId, Guid userId, bool isTeamLead = false, CancellationToken cancellationToken = default);
