...
public interface ITicketService
{
    ...
    /// <returns>Eine Liste von <see cref="TicketDto"/>.</returns>
    Task<IEnumerable<TicketDto>> GetFilteredTicketsAsync(Guid? projectId = null, Guid? assignedUserId = null, Guid? creatorId = null);
    ...
    /// <returns>Ein Task für die asynchrone Operation.</returns>
    Task AddDependencyAsync(Guid ticketId, Guid blockerId);
    ...
    Task RemoveDependencyAsync(Guid sourceId, Guid targetId);
    ...
    /// <returns>Ein Task.</returns>
    Task UploadAttachmentAsync(Guid ticketId, IFormFile file);
}
