...
Jeder Mitarbeiter sollte sich primär in seinem zugewiesenen Layer bewegen und die
Abhängigkeitsregeln respektieren.
...
Um das parallele Arbeiten im Team zu optimieren, hat jeder Layer seinen eigenen
dedizierten Entwicklungs-Branch. Feature-Entwicklungen finden primär auf diesen
Branches statt, bevor sie in den `main` Branch gemerged werden.
...
Abhängigkeiten zeigen **immer nur nach innen** (Richtung Domain). Ein "Outer
Layer" darf niemals direkt wissen, was in einem anderen "Outer Layer" passiert
(z.B. Web darf nicht direkt auf Infrastructure zugreifen).
