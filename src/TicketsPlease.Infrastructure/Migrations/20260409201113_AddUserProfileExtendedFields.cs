    ...
    public partial class AddUserProfileExtendedFields : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("32d733e1-4c7a-4c2d-9b51-1e9a7e6b7d21"), "32d733e1-4c7a-4c2d-9b51-1e9a7e6b7d21", null, "Full system access", false, "Admin", "ADMIN", new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("b8f2e9d2-6c8a-4d3e-ac62-2f0b8f7c8e33"), "b8f2e9d2-6c8a-4d3e-ac62-2f0b8f7c8e33", null, "Team lead permissions", false, "Teamlead", "TEAMLEAD", new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("c903f0e3-7d9b-4e4f-bd73-3f1c908d9f44"), "c903f0e3-7d9b-4e4f-bd73-3f1c908d9f44", null, "Standard user access", false, "User", "USER", new Guid("00000000-0000-0000-0000-000000000000") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("034734c7-b03f-5283-f017-735034c13388"), "#FF0000", null, false, 4, "Blocker", new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("d01401f4-8e0c-4f50-ce84-402d019e0055"), "#808080", null, false, 1, "Low", new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("e12512a5-9f1d-5061-df95-513e12af1166"), "#0000FF", null, false, 2, "Medium", new Guid("00000000-0000-0000-0000-000000000000") },
                    { new Guid("f23623b6-af2e-5172-ef06-624f23b02277"), "#FFA500", null, false, 3, "High", new Guid("00000000-0000-0000-0000-000000000000") }
                });

            migrationBuilder.InsertData(
                table: "Workflows",
                columns: new[] { "Id", "DeletedAt", "IsDeleted", "Name", "TenantId" },
                values: new object[] { new Guid("145845d8-c140-5394-0128-846145d24499"), null, false, "Standard Workflow", new Guid("00000000-0000-0000-0000-000000000000") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("256956e9-d251-54a5-1239-957256e35500"), "#D3D3D3", null, false, false, "Todo", 0, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("145845d8-c140-5394-0128-846145d24499") },
                    { new Guid("367a67fa-e362-55b6-234a-a68367f46611"), "#ADD8E6", null, false, false, "In Progress", 1, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("145845d8-c140-5394-0128-846145d24499") },
                    { new Guid("478b780b-f473-56c7-345b-b79478057722"), "#FFFFE0", null, false, false, "In Review", 2, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("145845d8-c140-5394-0128-846145d24499") },
                    { new Guid("589c891c-0584-57d8-456c-c8a589168833"), "#90EE90", null, false, true, "Done", 3, new Guid("00000000-0000-0000-0000-000000000000"), new Guid("145845d8-c140-5394-0128-846145d24499") }
                });
