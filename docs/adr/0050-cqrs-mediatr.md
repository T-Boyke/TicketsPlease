...
"God-Objects" zu werden, die zu viele Verantwortlichkeiten übernehmen. Wir benötigen ein Muster,
das die Logik für Lese- und Schreibvorgänge sauber trennt und die Kopplung minimiert.
...
Chosen option: "CQRS mit MediatR", because es jeden Use-Case (z.B. "Ticket erstellen") in eine eigene
Handler-Klasse isoliert. MediatR fungiert als In-Memory Message Bus, was die Kopplung zwischen
Web-API und Geschäftslogik auf ein Minimum reduziert.
