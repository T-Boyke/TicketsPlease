...
integrierte Methode in ASP.NET Core ist, um externe Bibliotheken versioniert und lokal zu
verwalten, ohne einen komplexen Node.js Build-Prozess zwingend vorauszusetzen.
