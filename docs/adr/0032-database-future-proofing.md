...
2. **Soft-Delete:** Alle Entitäten erben von einer `BaseEntity` mit `bool IsDeleted` und
   `DateTime? DeletedAt`. Physische Löschvorgänge werden durch logische ersetzt (Compliance &
   Revisionssicherheit).
