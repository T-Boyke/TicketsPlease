...
The TicketsPlease system requires a secure way to manage users, passwords, and permissions. We need to distinguish between standard "Users" (who can create and edit their own tickets) and "Admins" (who can manage system-wide settings and other users).
...
## Decision Outcome
Chosen option: "ASP.NET Core Identity", because it is the native, highly secure, and feature-rich framework for .NET. We will use a **Role-Based Access Control (RBAC)** approach.
...
2. **User**: Can create tickets, edit their own tickets, and participate in projects they are assigned to.
