...
codebase by default, there is a risk of configuration drift and lack of transparency for
developers.
...
- **Developer Experience**: New contributors can quickly see the repository's metadata
  requirements.
